...
public class DistributorTest {
    ...
    public void write() throws IOException {
        ...
        distributor.write(resource1.labelLavendelized("", Resource.md5(node.readBytes())), resource1.readData());
        distributor.write(resource2.labelLavendelized("", Resource.md5(node.readBytes())), resource1.readData());
