...
import net.oneandone.lavendel.publisher.pustefix.module.ModuleDescriptorType;
import net.oneandone.lavendel.publisher.pustefix.module.ResourceMappingType;
import net.oneandone.lavendel.publisher.pustefix.module.StaticType;
