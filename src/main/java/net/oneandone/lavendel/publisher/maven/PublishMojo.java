package net.oneandone.lavendel.publisher.maven;

import net.oneandone.lavendel.index.Index;
import net.oneandone.lavendel.publisher.Distributor;
import net.oneandone.lavendel.publisher.config.Net;
import net.oneandone.lavendel.publisher.WarEngine;
import net.oneandone.lavendel.publisher.Log;
import net.oneandone.lavendel.publisher.cli.War;
...
public class PublishMojo extends AbstractMojo {
    ...
    private void addCdsServlet(World world, File docroot) throws IOException {
        ...
        servletString += "<servlet-class>net.oneandone.lavendel.servlet.Cds</servlet-class>\n";
