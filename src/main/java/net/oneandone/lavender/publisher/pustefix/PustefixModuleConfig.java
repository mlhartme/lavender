...
import net.oneandone.lavender.publisher.pustefix.module.ModuleDescriptorType;
import net.oneandone.lavender.publisher.pustefix.module.ResourceMappingType;
import net.oneandone.lavender.publisher.pustefix.module.StaticType;
