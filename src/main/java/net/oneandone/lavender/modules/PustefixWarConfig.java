...
public class PustefixWarConfig {
    public static PustefixWarConfig fromXml(Node webapp) throws IOException {
        String path;
        Element root;
        Selector selector;
        List<String> statics;
        ...
        try {
            ...
            return new PustefixWarConfig(statics);
    ...
    public PustefixWarConfig(List<String> statics) {
